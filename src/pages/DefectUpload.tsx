    ...
    reader.onload = (evt) => {
      try {
        ...
        for (let i = headerRowIdx + 1; i < rows.length; i++) {
          ...
          entries.push({
            location_code: getVal(row, locCodeCol),
                  ...
                  <tr key={idx} className="border-t border-border/30">
                    ...
                    <td className="px-2 py-1 text-center">
                      <span className={`inline-block px-1.5 py-0.5 rounded text-[10px] font-bold ${
                        row.gravity === "S" ? "bg-destructive/15 text-destructive" :
              ...
              <tbody>
                {filteredDVXData.map((d) => (
                  <tr key={d.id} className="border-t border-border/30">
                    ...
                    <td className="px-2 py-1 text-center">
                      <span className={`inline-block px-1.5 py-0.5 rounded text-[10px] font-bold ${
                        d.gravity === "S" ? "bg-destructive/15 text-destructive" :
                    ...
                    <td className="px-2 py-1 text-center">
                      <span className={`inline-block px-1.5 py-0.5 rounded text-[10px] font-bold ${
                        d.pairing_status === "paired" ? "bg-primary/15 text-primary" : "bg-warning/15 text-warning"
